...
PAGE_CATALOG = [
    ...
    ("data_validation", "Analytics — Data Validation", "/analytics/data-validation"),
    ...
    ("sri_report", "System Reliability Report (SRI)", "/report-preparation/sri"),
    ...
    ("plant_deviation_report", "Plant Deviation from I/C - MOP", "/report-preparation/plant-deviation"),
    ...
    ("crew_threads", "Crew Notices", "/crew/threads"),
    ("crew_reports", "Crew Activity Reports", "/crew/reports"),
    ...
    ("mail_settings", "Mail, Two-Factor & CRMS Settings", "/admin/mail-settings"),
