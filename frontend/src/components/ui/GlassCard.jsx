  ...
  return (
    <Paper
      ...
      sx={{
        ...
        boxShadow: "0 12px 30px rgba(13, 87, 183, 0.05)",
        transition: "all .35s cubic-bezier(.17,.67,.38,.99)",
        p: padding,
        ...(hover && {
          "&:hover": {
            transform: "translateY(-4px)",
            boxShadow: "0 16px 36px rgba(13, 87, 183, 0.08)",
          },
        }),
        ...sx,
      }}
      ...
      {glow && (
        <Box
          sx={{
            ...
            height: 220,
            borderRadius: "50%",
            background: "rgba(43, 144, 104, 0.08)",
            filter: "blur(70px)",
            pointerEvents: "none",
          }}
        />
