    ...
    <AppShell>
      ...
      <GlassCard hover={false} padding={3} sx={{ maxWidth: 760 }}>
        <Stack spacing={2.5}>
          ...
          <Alert severity="info">This selector is a compatibility mechanism, not authentication. COMPASS uses the verified employee ID and role from the authenticated session.</Alert>
